    ...
    return (
        <>
            <div className="flex items-center justify-center min-h-screen bg-black-100">
                ...
                <div className="relative text-white z-10 text-center px-4">
                    ...
                    <button className="text-2xl font-bold py-3 px-6 rounded-md bg-black hover:bg-white hover:text-black transition-colors duration-300">
                        Get Started
                    </button>
                </div>
            </div>

            <div className="bg-black py-12 mt-0">
